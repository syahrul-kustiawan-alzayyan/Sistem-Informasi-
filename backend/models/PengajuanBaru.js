...
const PengajuanBaruSchema = new mongoose.Schema({
...
PengajuanBaruSchema.pre('save', function(next) {
...
const PengajuanBaruModel = mongoose.model('Pengajuanbaru', PengajuanBaruSchema);
module.exports = PengajuanBaruModel;