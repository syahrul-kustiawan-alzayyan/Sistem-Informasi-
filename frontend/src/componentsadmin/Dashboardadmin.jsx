...
const DashboardAdmin = () => {
  ...
  const [totalStatsPengajuanPembaharuan, setTotalStatsPengajuanPembaharuan] = useState(null);
  ...
  useEffect(() => {
    ...
    const fetchTotalStatsPengajuanBaru = async () => {
      try {
        const response = await axios.get('http://localhost:3001/stats/totalpengajuanbaru');
    ...
    const fetchTotalStatsPengajuanPembaharuan = async () => {
      try {
        const response = await axios.get('http://localhost:3001/stats/totalpengajuanpembaharuan');
  ...
  return (
    ...
    <div className="stats-container">
      <div className="stat-card">
        ...
        <p>{totalStatsPengajuanBaru ? totalStatsPengajuanBaru.totalPengajuanBaru : 'Loading...'}</p>
      </div>
      <div className="stat-card">
        <h3>Pengajuan Pembaharuan</h3>
        <p>{totalStatsPengajuanPembaharuan ? totalStatsPengajuanPembaharuan.totalPengajuanPembaharuan : 'Loading...'}</p>
      </div>
      <div className="stat-card">
        <h3>Total Majelis Taklim</h3>
        <p>{totalStatsMajelisTaklim ? totalStatsMajelisTaklim.totalMajelis : 'Loading...'}</p>
      </div>
    </div>
